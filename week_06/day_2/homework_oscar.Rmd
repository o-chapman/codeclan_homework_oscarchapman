...
phones <- janitor::clean_names(read_csv("data/20190928-items.csv"))
...
samsung_phones %>%
  ggplot(aes(x = mean(rating), y = sd(rating))) +
...
pnorm(4, mean = mean(samsung_phones$rating), sd = sd(samsung_phones$rating))
```
