...
```{r}
# H0: The difference in means between a sleep for herbivores and omnivores is 0
# H1: The difference is more than 0

observed_stat <- mean((msleep %>% filter(vore == "omni"))$sleep_total, na.rm = TRUE) - mean((msleep %>% filter(vore == "herbi"))$sleep_total, na.rm = TRUE)
