...
The diagnostics look fine for this model as there is no massive variation in the plots from what they should look like.  
The Residuals vs. Fitted graph varies randomly around 0 and by a small amount, the Q-Q graph sticks to the line finely and the Scale-Outlier graph isn't in an upwards or downwards trend. The only outliers we have are 5 and 18.  
The p-value is also well below 0.05.
